...
// - retain <body onload="startTime()"> if followed by <noscript>
...
function minify(value, options, partialMarkup) {
  ...
  new HTMLParser(value, {
    ...
    start: function(tag, attrs, unary, unarySlash, autoGenerated) {
      ...
      if (optional) {
        ...
        // <body onload="startTime()"> may be omitted if first thing inside is not space, comment, <meta>, <link>, <script>, <style> or <template>
      ...
      if (options.removeOptionalTags) {
        // <html>, <head> or <body onload="startTime()"> may be omitted if the element is empty
  ...
  if (options.removeOptionalTags) {
    // <html> may be omitted if first thing inside is not comment
    // <head> or <body onload="startTime()"> may be omitted if empty
