...
function Server(compiler, options) {
  ...
  app.get('/webpack-dev-server', (req, res) => {
    res.setHeader('Content-Type', 'text/html');
    res.write('<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body onload="startTime()">');
...
Server.prototype.serveMagicHtml = function (req, res, next) {
  ...
  try {
    ...
    res.write('<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body onload="startTime()"><script type="text/javascript" charset="utf-8" src="');
    res.write(_path);
    res.write('.js');
