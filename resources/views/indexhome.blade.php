...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link" href="#">Bidang PEMERINTAHAN</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Panduan PENDUDUK</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Halaman BISNIS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Untuk PENGUNJUNG</a>
      </li>
    ...
    <div class="row">
        <div class="col-md-2 offset-md-1">
            <div class="inner text-center">
                ...
                <h4><strong>LEMBAGA</strong></h3>
            </div>
        </div>
        <div class="col-md-2">
            <div class="inner text-center">
                <i class="fas fa-users"></i><br>
                <h4><strong>SOTK</strong></h3>
            </div>
        </div>
        <div class="col-md-2">
            <div class="inner text-center">
                <i class="fas fa-map-marked-alt"></i><br>
                <h4><strong>PETA</strong></h3>
            </div>
        </div>
        <div class="col-md-2">
            <div class="inner text-center">
                <i class="fas fa-calendar-alt"></i><br>
                <h4><strong>AGENDA</strong></h3>
            </div>
        </div>
        <div class="col-md-2">
            <div class="inner text-center">
                <i class="fas fa-chart-bar"></i><br>
                <h4><strong>DATA</strong></h3>
            </div>
        </div>
    </div>
</div>
...
<footer>
    ...
    <script src="/js/date.js" type="text/javascript" charset="utf-8" async defer></script>
  </body>
</html>