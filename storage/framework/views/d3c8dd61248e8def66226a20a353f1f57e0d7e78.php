...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
     ...
     <form action="<?php echo e(url('editdatapendudukkades/' .  $data_penduduks[0]->NIK .'/'.$data_penduduks[0]->Id_Dusun )); ?>" method="post" enctype="multipart/form-data" class="padding_form">
