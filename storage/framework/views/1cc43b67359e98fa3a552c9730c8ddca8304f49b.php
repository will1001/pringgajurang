...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <form action=<?php echo e(url('editSOTK/' .  $SOTKs->id )); ?> method="post" enctype="multipart/form-data" style="padding-top: 100px;">
          <?php echo e(csrf_field()); ?>

          Nama :<br>
          <input type="text" name="Nama" value="<?php echo e($SOTKs->Nama); ?>"><br><br>
          Gambar : <br><br>
