    ...
    <section id="lembaga" class="section-padding">
      ...
      <div class="row" id="visimisi">
        <div class="col-md-12">
          ...
          <ul>
            <li>Menggali potensi yang ada di Desa Pedekik.</li>
            <li>Meningkatkan kualitas kehidupan sosial ekonomi Masyarakat Desa Pedekik.</li>
            ...
            <li>Sebagai mitra pemerintahan Desa Pedekik.</li>
          </ul>
