...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/profildesa.css')); ?>">
...
<body onload="startTime()" data-spy="scroll" data-target="#primary-menu">
      ...
      <div class="container">
       <div class="row" id="bgprofil">
        <div class="col-xs-12 col-12 col-sm-12 col-md-12">
          <h1 class="text-center">Tentang Desa Pringgajurang</h1>
           <img src="images/profildesa-img.jpg" alt="fotodesa">
            <p><?php echo e($profildesas[0]->desripsiprofildesa); ?></p> <br>
        </div>
      </div>
    ...
    <section id="visimisi">
      <div class="container">
      <h1>Visi dan Misi Desa Pringgajurang</h1>
      <div class="row">
        <div class="col-md-12">
            <h1>VISI</h1>
            <p>MASYARAKAT DESA Pringgajurang YANG SEJAHTERA, SEHAT, CERDAS, DAN
      ...
      <div class="row">
        <div class="col-md-12">
            <h1>MISI</h1>
            <p>Dalam kurun waktu 6 (enam) tahun (2019 – 2024), Pemerintah Desa Pringgajurang telah
            menetapkan missi pembangunan, dalam rangka mencapai visi tersebut di atas. Missi
            Pembangunan Desa Pringgajurang 2019- 2024 adalah :</p>
            <ol>
              ...
              dan berorientasi pada “pelayanan terbaik bagi masyarakat” Desa Pringgajurang.
              </li>
              <li>Mengoptimalkan pengelolaan potensi-potensi ekonomi dan potensi sumberdaya
              alam Desa Pringgajurang, dalam rangka penciptaan lapangan kerja dan peningkatan
              ...
              kondusifitas di seluruh wilayah Desa Pringgajurang.</li>
              <li>Membangun tatanan kehidupan yang harmonis, berbudaya dan religius melalui
              pembinaan dan pemberdayaan masyarakat di desa Pringgajurang</li>
    ...
    <section id="gambaran-umum">
      <div class="container">
        <h1>Gambaran Umum Desa Pringgajurang</h1>
      <div class="row">
        <div class="col-md-12">
            
          <h3>TOPOGRAFI DAN DEMOGRAFI</h3>

            <p>Desa Pringgajurang secara umum terdiri dari dataran yang berada pada ketinggian sekitar 3,5 meter dari permukaan laut (Mdpl). Keadaan tekstur tanahnya sebagian merupakan lempungan berwarna abu-abu dan sebagian lagi wilayah gambut berwarna coklat.</p>


            <p>Adapun luas desa Pringgajurang lebih kurang 2050 Hektar yang mayoritasnya merupakan wilayah perkebunan dengan jenis tanaman karet dan sawit. Selebihnya adalah wilayah pemukiman dengan luas sekitar 241,5 Hektar. Sementara wilayah Dusun terluas berada di Dusun III dan IV.</p>


            <p>Secara geografis desa Pringgajurang terletak pada kordinat 102,118761 Bujur Timur dan 1,516449 Lintang Utara yang wilayah admisitratifnya berbatasan dengan :
            </p>
            ...
            <p>Jarak Desa Pringgajurang ke Ibukota Kecamatan lebih kurang 10 Km yang bisa ditempuh dalam waktu 15 menit menggunakan kendaraan bermotor. Sedangkan jarak menuju ke Ibukota Kabupaten lebih kurang 5 Km dengan waktu tempuh rata-rata sekitar 7 menit. Sehingga keberadaan desa Pringgajurang ini masih terbilang berada di pinggiran Kota Kabupaten.</p>

            <p>Dari sisi demografis Desa Pringgajurang memiliki penduduk dengan jumlah 2556 jiwa yang terdiri dari 1316 orang laki-laki dan 1240 orang perempuan yang tergabung dalam 695 Kepala Keluarga (KK). Kepadatan penduduk saat ini tercatat 124 jiwa per Km2 dengan persentase perkembangan penduduk dari tahun lalu sebesar 1,39%.</p>

            <p>Untuk penyebaran penduduk terbanyak berada di Dusun II Pringgajurang Tengah. Sebaran penduduk per wilayah dusun bisa dilihat pada tabel dibawah :</p>
    ...
    <section id="peta-desa">
      <div class="container">
        <h1>Peta Wilayah Desa Pringgajurang</h1>
      <div class="row">
        <div class="col-xs-12 col-12 col-sm-12 col-md-12">
