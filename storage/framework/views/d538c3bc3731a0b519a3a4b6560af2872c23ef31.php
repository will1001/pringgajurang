  ...
  <div class="row">
    <div class="col-md-12">
      <?php if($errors->any()): ?>
        ...
        <?php endif; ?>
     <form action="<?php echo e(url('editdatapendudukwarga/' .  $data_penduduks[0]->NIK .'/'.$data_penduduks[0]->Id_Dusun )); ?>" method="post" enctype="multipart/form-data" style="padding-top: 100px;">
          ...
          <select name="Id_Dusun">
                 <option selected="true" value="<?php echo e($kode_area_dusun_defaults[0]->id_dusun); ?>"><?php echo e($kode_area_dusun_defaults[0]->Nama_Dusun); ?></option>
