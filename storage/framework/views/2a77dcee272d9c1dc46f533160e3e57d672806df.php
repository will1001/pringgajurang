    ...
    <section id="kotak3" v-if="!isHidden">
                ...
                <div class="row">
                    ...
                    <div class="col-4 col-xs-4 col-sm-4 col-md-2">
                        <div class="inner text-center">
                            <a href="<?php echo e(url('/organisasi')); ?>"><i class="fa-2x fas fa-users"></i><br>
                          ...
                          <div style="overflow: auto;max-height: 400px;position: relative;margin: 5px 25px;">
                            ...
                            <tbody id="tbodytabel">
                              <?php
                                $no=1
                              ?>
                            <?php $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agendas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                <td><?php echo e($no++); ?></td>
                                <td><?php echo e($agendas->agenda); ?></td>
                                <td><?php echo e($agendas->tgl_agenda); ?></td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </tr>
                            </tbody>
                          </table>
