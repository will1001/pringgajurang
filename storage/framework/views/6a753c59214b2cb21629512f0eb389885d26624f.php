...
<div class="collapse navbar-collapse" id="collapsesidebar">
         ...
         <ul class="sidebar_ul pd-2 text-uppercase text-left">
              ...
              <li class="nav-item">
                <a class="nav-link setkopsurat" @click="currentView='';" href="<?php echo e(url('formsettingkopsurat')); ?>" >Setting Kop Surat</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" @click="currentView='';" href="<?php echo e(url('formuploadapbd/apbd')); ?>">Upload APBD Desa</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" @click="currentView='';" href="<?php echo e(url('formuploadapbd/rkp')); ?>">Upload RKP Desa</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" @click="currentView='';" href="<?php echo e(url('formuploadapbd/rpjm')); ?>">Upload RPJM Desa</a>
              </li>
       </ul>
     </div>
      </nav>
...
<template id="tabelakunlogindesa">
  <div>
    ...
    <!-- <script type="text/javascript" src="<?php echo e(asset('/vue/vueadmin.js')); ?>"></script> -->
