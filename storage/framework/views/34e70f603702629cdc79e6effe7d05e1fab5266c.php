...
<head>
  ...
  <link href="<?php echo e(asset('color/default.css')); ?>" rel="stylesheet" media="screen">
   <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/transparansi.css')); ?>">
      ...
      <div class=" collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="<?php echo e(url('/')); ?>" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Transparansi
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<?php echo e(url('transparansi/apbd')); ?>">APBDes</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(url('transparansi/rpjm')); ?>">RPJMDes</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo e(url('transparansi/rkp')); ?>">RKPDes</a>
              </div>
            </li>
         </ul>
      </div>
