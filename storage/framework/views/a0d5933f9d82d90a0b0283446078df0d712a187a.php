    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[3]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[3]->urlgambar); ?>" alt=""  />
            <h4><?php echo e($SOTKs[3]->Nama); ?></h4>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[4]->urlgambar); ?>" alt=""  />
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[5]->urlgambar); ?>" alt=""  />
      ...
      <div class="row">
          ...
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[6]->urlgambar); ?>" alt=""  />
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[7]->urlgambar); ?>" alt=""  />
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="wow bounceInUp text-center" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[8]->urlgambar); ?>" alt=""  />
