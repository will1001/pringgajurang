...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <form action="<?php echo e(url('editnmrhp/' .  $users[0]->id )); ?>" method="post" enctype="multipart/form-data" style="padding-top: 100px;">
          <?php echo e(csrf_field()); ?>

          Nomor HP :<br>
          <input type="text" name="nmrhp" value="<?php echo e($users[0]->No_HP); ?>"><br><br>
