              ...
              <?php if(auth()->guard()->guest()): ?>
                    ...
                    <?php else: ?>
                           <li class="nav-item dropdown">
                              <a class="nav-link mt-4" href="<?php echo e(url('formeditnmrhp/'.$data_penduduks[0]->Nomor_KK)); ?>">UBAH NOMOR HP</a>
                          </li>
                        
                          <li class="nav-item dropdown">
                               <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                  <?php echo e(Auth::user()->Nomor_KK); ?> <span class="caret"></span>
                              </a>
...
<section class="section-padding" id="biodata">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center">Nomor KK : <?php echo e($data_penduduks[0]->Nomor_KK); ?></h1><br><br>
        </div>
    </div>
    <div class="row">
      <div class="col-md-12">
      ...
      <tbody id="tbodytabel">
        ...
        <?php $__currentLoopData = $data_penduduks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_penduduk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td ><a href="<?php echo e($data_penduduk->foto_kk); ?>">lihat</a></td>
            <?php endif; ?>      
            <td><a href="formeditdatapendudukwarga/<?php echo e($data_penduduk->NIK); ?>/<?php echo e($data_penduduk->Id_Dusun); ?>">edit</a></td>
          </tr>
      ...
      <div class="col-md-12 text-left">
         <select id="pilihsurat">
          ...
          <select name="NIKsurat" id="NIKsurat">   
                 <?php $__currentLoopData = $data_penduduks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_penduduk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($data_penduduk->NIK); ?>"><?php echo e($data_penduduk->Nama); ?></option>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select><br><br>
