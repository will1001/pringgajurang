    ...
    <div class="container">
      <div class="row">
          ...
          <div class="box-team wow bounceInUp text-center" data-wow-delay="0.1s">
            <h4><?php echo e($SOTKs[0]->Jabatan); ?></h4>
            <img src="<?php echo e($SOTKs[0]->urlgambar); ?>" alt="" class="img-responsive" />
  ...
  <section id="sekretaris">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <div class="box-team wow bounceInUp text-center" data-wow-delay="0.1s">
            <h4><?php echo e($SOTKs[2]->Jabatan); ?></h4>
            <img src="<?php echo e($SOTKs[2]->urlgambar); ?>" alt="" class="img-responsive" />
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[4]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[4]->urlgambar); ?>" alt="" class="img-responsive" />
            <h4><?php echo e($SOTKs[4]->Nama); ?></h4>
          </div>
        </div>

        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[5]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[5]->urlgambar); ?>" alt="" class="img-responsive" />
            <h4><?php echo e($SOTKs[5]->Nama); ?></h4>
          </div>
        </div> 

        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[6]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[6]->urlgambar); ?>" alt="" class="img-responsive" />
            <h4><?php echo e($SOTKs[6]->Nama); ?></h4>
          </div>
        </div>
      </div>
      ...
      <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[7]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[7]->urlgambar); ?>" alt="" class="img-responsive" />
            <h4><?php echo e($SOTKs[7]->Nama); ?></h4>
          </div>
        </div>

        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
            <p><?php echo e($SOTKs[8]->Jabatan); ?></p>
           <img src="<?php echo e($SOTKs[8]->urlgambar); ?>" alt="" class="img-responsive" />
            <h4><?php echo e($SOTKs[8]->Nama); ?></h4>
          </div>
        </div> 
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
          <div class="box-team wow bounceInUp" data-wow-delay="0.5s">
           ...
           <img src="<?php echo e($SOTKs[9]->urlgambar); ?>" alt="" class="img-responsive" />
