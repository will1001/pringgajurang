                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6 col-6 col-sm-6 col-md-6">
                                <input id="Nomor_KK" type="text" class="form-control<?php echo e($errors->has('Nomor_KK') ? ' is-invalid' : ''); ?>" name="Nomor_KK" value="<?php echo e(old('Nomor_KK')); ?>" required placeholder="  Nomor_KK">

                                <?php if($errors->has('Nomor_KK')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('Nomor_KK')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
